...
class Components(SchemaBasedObject):
    schemas: Optional[Dict[str, Union[Union[Schema, Dict[str, Union[str]]]]]] = ...
    responses: Optional[Dict[str, Union[Union[Dict[str, Union[str]], Response]]]] = ...
    parameters: Optional[Dict[str, Union[Union[Dict[str, Union[str]], Parameter]]]] = ...
    examples: Optional[Dict[str, Union[Union[Dict[str, Union[str]], Example]]]] = ...
    requestBodies: Optional[Dict[str, Union[Union[Dict[str, Union[str]], RequestBody]]]] = ...
    headers: Optional[Dict[str, Union[Union[Dict[str, Union[str]], Header]]]] = ...
    securitySchemes: Optional[Dict[str, Union[Union[Dict[str, Union[str]], Union[APIKeySecurityScheme, HTTPSecurityScheme, OAuth2SecurityScheme, OpenIdConnectSecurityScheme]]]]] = ...
    links: Optional[Dict[str, Union[Union[Dict[str, Union[str]], Link]]]] = ...
    callbacks: Optional[Dict[str, Union[Union[Dict[str, Union[str]], Dict[str, Union[Any]]]]]] = ...

    # noinspection PyMissingConstructor
    def __init__(self, schemas: Optional[Dict[str, Union[Union[Schema, Dict[str, Union[str]]]]]] = None, responses: Optional[Dict[str, Union[Union[Dict[str, Union[str]], Response]]]] = None, parameters: Optional[Dict[str, Union[Union[Dict[str, Union[str]], Parameter]]]] = None, examples: Optional[Dict[str, Union[Union[Dict[str, Union[str]], Example]]]] = None, requestBodies: Optional[Dict[str, Union[Union[Dict[str, Union[str]], RequestBody]]]] = None, headers: Optional[Dict[str, Union[Union[Dict[str, Union[str]], Header]]]] = None, securitySchemes: Optional[Dict[str, Union[Union[Dict[str, Union[str]], Union[APIKeySecurityScheme, HTTPSecurityScheme, OAuth2SecurityScheme, OpenIdConnectSecurityScheme]]]]] = None, links: Optional[Dict[str, Union[Union[Dict[str, Union[str]], Link]]]] = None, callbacks: Optional[Dict[str, Union[Union[Dict[str, Union[str]], Dict[str, Union[Any]]]]]] = None, **kwargs): ...
...
class Header(SchemaBasedObject):
    ...
    explode: Optional[bool] = ...
    allowReserved: Optional[bool] = ...
    schema: Optional[Union[Schema, Dict[str, Union[str]]]] = ...
    content: Optional[Dict[str, MediaType]] = ...
    example: Optional[Any] = ...
    examples: Optional[Dict[str, Union[Example, Dict[str, Union[str]]]]] = ...

    # noinspection PyMissingConstructor
    def __init__(self, description: Optional[str] = None, required: Optional[bool] = None, deprecated: Optional[bool] = None, allowEmptyValue: Optional[bool] = None, style: Optional[str] = None, explode: Optional[bool] = None, allowReserved: Optional[bool] = None, schema: Optional[Union[Schema, Dict[str, Union[str]]]] = None, content: Optional[Dict[str, MediaType]] = None, example: Optional[Any] = None, examples: Optional[Dict[str, Union[Example, Dict[str, Union[str]]]]] = None, **kwargs): ...
...
class MediaType(SchemaBasedObject):
    ...
    # noinspection PyMissingConstructor
    def __init__(self, schema: Optional[Union[Schema, Dict[str, Union[str]]]] = None, example: Optional[Any] = None, examples: Optional[Dict[str, Union[Example, Dict[str, Union[str]]]]] = None, encoding: Optional[Dict[str, Encoding]] = None, **kwargs): ...
...
class Operation(SchemaBasedObject):
    ...
    operationId: Optional[str] = ...
    parameters: Optional[List[Union[Parameter, Dict[str, Union[str]]]]] = ...
    requestBody: Optional[Union[RequestBody, Dict[str, Union[str]]]] = ...
    responses: Responses = ...
    callbacks: Optional[Dict[str, Union[Dict[str, Union[Any]], Dict[str, Union[str]]]]] = ...
    deprecated: Optional[bool] = ...
    security: Optional[List[Dict[str, List[str]]]] = ...
    servers: Optional[List[Server]] = ...

    # noinspection PyMissingConstructor
    def __init__(self, responses: Responses, tags: Optional[List[str]] = None, summary: Optional[str] = None, description: Optional[str] = None, externalDocs: Optional[ExternalDocumentation] = None, operationId: Optional[str] = None, parameters: Optional[List[Union[Parameter, Dict[str, Union[str]]]]] = None, requestBody: Optional[Union[RequestBody, Dict[str, Union[str]]]] = None, callbacks: Optional[Dict[str, Union[Dict[str, Union[Any]], Dict[str, Union[str]]]]] = None, deprecated: Optional[bool] = None, security: Optional[List[Dict[str, List[str]]]] = None, servers: Optional[List[Server]] = None, **kwargs): ...
...
class PathItem(SchemaBasedObject):
    ...
    # noinspection PyMissingConstructor
    def __init__(self, dollar_ref: Optional[str] = None, summary: Optional[str] = None, description: Optional[str] = None, servers: Optional[List[Server]] = None, parameters: Optional[List[Union[Parameter, Dict[str, Union[str]]]]] = None, **kwargs): ...
...
class Response(SchemaBasedObject):
    description: str = ...
    headers: Optional[Dict[str, Union[Header, Dict[str, Union[str]]]]] = ...
    content: Optional[Dict[str, MediaType]] = ...
    links: Optional[Dict[str, Union[Link, Dict[str, Union[str]]]]] = ...

    # noinspection PyMissingConstructor
    def __init__(self, description: str, headers: Optional[Dict[str, Union[Header, Dict[str, Union[str]]]]] = None, content: Optional[Dict[str, MediaType]] = None, links: Optional[Dict[str, Union[Link, Dict[str, Union[str]]]]] = None, **kwargs): ...

    def __getitem__(self, item) -> Union[Any]: ...

class Responses(SchemaBasedObject):
    default: Optional[Union[Response, Dict[str, Union[str]]]] = ...

    # noinspection PyMissingConstructor
    def __init__(self, default: Optional[Union[Response, Dict[str, Union[str]]]] = None, **kwargs): ...

    def __getitem__(self, item) -> Union[Union[Response, Dict[str, Union[str]]], Any]: ...
...
class Schema(SchemaBasedObject):
    ...
    type: Optional[str] = ...
    not_: Optional[Any] = ...
    allOf: Optional[List[Union[Any, Dict[str, Union[str]]]]] = ...
    oneOf: Optional[List[Union[Schema, Dict[str, Union[str]]]]] = ...
    anyOf: Optional[List[Union[Schema, Dict[str, Union[str]]]]] = ...
    items: Optional[Union[Schema, Dict[str, Union[str]]]] = ...
    properties: Optional[Dict[str, Union[Schema, Dict[str, Union[str]]]]] = ...
    additionalProperties: Optional[Union[Schema, Dict[str, Union[str]], bool]] = ...
    description: Optional[str] = ...
    format: Optional[str] = ...
